...
**Hit points**: 17 (15 at the end of 2/3/24)
...
#Weight <- c("13 lb.", "1 lb.", "3 lb.", "2 lb.", "N/A")
...
crossbow <- data.frame(name="Crossbow, hand", damage="1d6 piercing", weight="3 lb.",
                 prop="Ammunition, range (30/120), light, loading", type="Martial ranged weapon")

crossbow_bolts <- data.frame(name="Crossbow bolts", damage="N/A", weight="N/A", prop="39 bolts", 
                             type="Ammunition")

weaparmor <- rbind(studded_armor, rapier, dagger, magic_dagger, crossbow, crossbow_bolts) %>% 
